 ...
 * 
 * @see application.Pagamento.PagamentoService
...
public abstract class Pagamento implements Cloneable {
	...
	/**
	 * Confronta due oggetti Pagamento per determinare se sono equivalenti.
	 * 
	 * Il confronto avviene sulla base dei seguenti attributi:
	 * - codice di pagamento
	 * - data di pagamento
	 * - importo
	 * - ora di pagamento (solo ore e minuti)
	 * - ordine associato al pagamento
	 * 
	...
	public boolean equals(Object obj) {
		...
		// Casting dell'oggetto a Pagamento
		Pagamento other = (Pagamento) obj;

		if (codicePagamento != other.codicePagamento) {
			return false;
		}

		if (!dataPagamento.equals(other.dataPagamento)) {
			return false;
		}

		if (Float.compare(other.importo, importo) != 0) {
			return false;
		}
		...
		// Confronto delle ore e dei minuti
		if (!oraPagamento.format(formatter).equals(other.oraPagamento.format(formatter))) {
			return false;
		}

		
		return ordine.equals(other.ordine);
	}
