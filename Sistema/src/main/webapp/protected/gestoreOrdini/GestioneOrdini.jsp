...
<link rel="stylesheet"
	href="<%= request.getContextPath()%>/style/catalog_options.css">
<link rel="stylesheet"
	href="<%= request.getContextPath()%>/style/product_table.css">
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script
	src="<%= request.getContextPath()%>/scripts/ajax_orders_table_functions.js?ts=<%= System.currentTimeMillis() %>"></script>
<script
	src="<%= request.getContextPath()%>/scripts/pagination.js?ts=<%= System.currentTimeMillis() %>"></script>
...
<body>
	...
	<main class="main-content" id="mainContent">
		<section id="centerMenu" class="center-menu">
			<div class="fe-box" id="viewOrders"
				onclick="moveToSidebar('viewOrders', 'viewOrdersForm'); fetchOrders(1, 'fetch_da_spedire')">
				<img
					src="<%= request.getContextPath()%>/images/site_images/ordinidaspedire.png"
					alt="Visualizza Ordini Clienti">
				<h5>Visualizza Ordini Da Spedire</h5>
			</div>
			<div class="fe-box" id="viewSentOrders"
				onclick="moveToSidebar('viewSentOrders', 'viewOrdersForm'); fetchOrders(1, 'fetch_spediti')">
				<img
					src="<%= request.getContextPath()%>/images/site_images/ordinispediti.png"
					alt="Visualizza Ordini Spediti">
				<h5>Visualizza Ordini Spediti</h5>
			</div>
			<div class="fe-box" id="supplyingRequests">
				<a href="GestioneApprovigionamentiController?action=viewList&page=1"><img
					src="<%= request.getContextPath()%>/images/site_images/supplyrequests.png"
					alt="Richieste Approvvigionamento"></a>
				<h5>Richieste Approvvigionamento</h5>
			</div>
			<div class="fe-box" id="supplyingRequest">
				<a
					href="GestioneApprovigionamentiController?action=viewProductList&page=1"><img
					src="<%= request.getContextPath()%>/images/site_images/approvvigionamento.png"
					alt="Approvvigionamento"> </a>
	...
	<script
		src="<%= request.getContextPath()%>/scripts/shifting_menu_manag_functions_sidebar.js"></script>
