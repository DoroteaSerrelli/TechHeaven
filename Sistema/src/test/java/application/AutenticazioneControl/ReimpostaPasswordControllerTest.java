...
import application.Autenticazione.AutenticazioneControl.ReimpostaPasswordController;
...
public class ReimpostaPasswordControllerTest {
	...
	public void testDoPost_TC4_1_4() throws SQLException, ServletException, IOException, UtenteInesistenteException, FormatoPasswordException, PasswordEsistenteException, FormatoEmailException {
		...
		doThrow(new FormatoPasswordException("La password deve avere almeno 5 caratteri che siano lettere e numeri.")).when(loginService).resetPassword(username, email, password);
	...
	public void testDoPost_TC4_1_5() throws SQLException, ServletException, IOException, UtenteInesistenteException, FormatoPasswordException, PasswordEsistenteException, FormatoEmailException {
		...
		doThrow(new PasswordEsistenteException("Non è possibile associare questa password al tuo account. Inserisci una altra password.")).when(loginService).resetPassword(username, email, password);
