    ...
    <body>
        ...
        <div class="section-p1"><form name="client" method="post" action="RegistrazioneController">           
            <div class="row">
                ...
                <div class="input-wrapper reg_form">
                    <p> *Surname: </p>
                    <input type="text" name="surname" oninput="validateSurname()" required>
                </div>
            </div>  
            <div class="row">     
                 <div class="input-wrapper reg_form">             
                    <p>  *Address Road: </p>
                    <input id="road" type="text" name="road" oninput="validateAddress()"required>
                 </div>    
                 <div class="input-wrapper reg_form">                           
                    <p> *Civic Number: </p>
                    <input id="cv" type="text" name="cv" oninput="validateAddress()"required>
                 </div>
            </div>  
            <div class="row">
                 <div class="input-wrapper reg_form">                      
                    <p>  *Address City: </p>
                    <input id="city" type="text" name="city" oninput="validateAddress()"required>
                 </div> 
               <div class="input-wrapper reg_form">            
                    <p>  *CAP: </p>
                    <input id="cap" type="text" name="cap" oninput="validateAddress()"required>
              </div>               
            </div>
            <div class="row">
                <div class="input-wrapper reg_form">             
                    <p>  *Province: </p>
                    <input id="province" type="text" name="province" oninput="validateAddress()"required>
              </div>
                 <div class="input-wrapper reg_form">             
                    <p>  *Sex: </p>
            ...
            <div class="row"> 
                ...
                <div class="input-wrapper reg_form">
                    <p>  *Phone Number: </p>
                    <input type="text" name="phoneNumber" oninput="validatePhoneNumber()" required>
                </div>
            </div>
            <div class="row"> 
                 <div class="input-wrapper reg_form">              
