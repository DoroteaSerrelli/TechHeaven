...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/style/catalog_options.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/style/product_table.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/style/catalog_form.css">
...
<script
	src="${pageContext.request.contextPath}/scripts/indexedDBUtils.js"></script>
</head>
<body>
	...
	<aside class="options_sidebar hidden" id="options_sidebar">
		<button id="sidebar_toggle">
			<img
				src="${pageContext.request.contextPath}/images/site_images/sidebar_toggle.png"
	...
	<main class="main-content" id="mainContent">
		...
		<section id="centerMenu" class="center-menu">
			<div class="fe-box" id="viewProducts"
				onclick="moveToSidebar('viewProducts', 'viewProductsForm')">
				<img
					src="${pageContext.request.contextPath}/images/site_images/listaprodotto.png"
					alt="Visualizza Prodotti">
				<h6>Visualizza Prodotti</h6>
			</div>
			<div class="fe-box" id="addProduct"
				onclick="moveToSidebar('addProduct', 'addProductForm')">
				<img
					src="${pageContext.request.contextPath}/images/site_images/addprodotto.png"
					alt="Aggiungi un nuovo prodotto">
			...
			<div class="fe-box" id="removeProduct"
				onclick="resetProductData('delete')">
				<a href="javascript:void(0)"><img
					src="${pageContext.request.contextPath}/images/site_images/removeprodotto.png"
					alt="Elimina un prodotto"></a>
				<h6>Elimina un prodotto</h6>
			</div>
			<div class="fe-box" id="modifyProperties"
				onclick="resetProductData('modify')">
				<a href="javascript:void(0)"> <img
					src="${pageContext.request.contextPath}/images/site_images/modproperties.png"
					alt="Modifica caratteristiche prodotto">
				</a>
	...
	<section id="forms">
		...
		<section id="addProductForm" class="form-section hidden">
			...
			<form
				action="${pageContext.request.contextPath}/GestioneCatalogoController"
				method="post" enctype="multipart/form-data">
				<div id="error"></div>
				<div class="form-group">
					<label for="productID"> ID Prodotto </label> <input type="number"
						id="number" name="productId"
						oninput="validateProductID(this, 'ID')" required>
					<div id="prodIDError" class="erromsg" style="display: none;"></div>
					<label for="productName">Nome Prodotto:</label> <input type="text"
						id="productName" name="productName"
						oninput="validateProductNameorModel(this, 'Nome')" required>
					<div id="prodNomeError" class="erromsg" style="display: none;"></div>
				</div>
				<div class="form-group">
					<label for="TopDescrizione">Top Descrizione:</label>
					<textarea name="topDescrizione" rows="5" cols="40"
						oninput="validateDettailsAndDescription(this, 'Descrizione')"
						required></textarea>
					<div id="prodDescrizioneError" class="erromsg"
						style="display: none;"></div>
					<label for="Dettagli">Dettagli:</label>
					<textarea name="dettagli" rows="5" cols="40"
						oninput="validateDettailsAndDescription(this, 'Dettagli')"
						required></textarea>
					<div id="prodDettagliError" class="erromsg" style="display: none;"></div>
				</div>
				<div class="form-group">
					<label for="prezzo">Prezzo:</label> <input type="text" name="price"
						oninput="validatePrice(this, 'Prezzo')" required>
					<div id="prodPrezzoError" class="erromsg" style="display: none;"></div>
				</div>
				<div class="form-group">
					<select name="categoria">
						<option value="GRANDI_ELETTRODOMESTICI">Grandi
							Elettrodomestici</option>
						<option value="PICCOLI_ELETTRODOMESTICI">Piccoli
							Elettrodomestici</option>
						<option value="TELEFONIA">Telefonia</option>
						<option value="PRODOTTI_ELETTRONICA">Prodotti Elettronica</option>
					</select> <select name="sottocategoria">
				...
				<div class="form-group">
					<label for="marca">Marca:</label> <input type="text" id="marca"
						name="marca" oninput="validateBrand(this)" required>
				...
				<div class="form-group">
					<label for="modello">Modello:</label> <input type="text"
						...
						oninput="validateProductNameorModel(this, 'Modello')" required>
					<div id="prodModelloError" class="erromsg" style="display: none;"></div>
				</div>
				<div class="form-group">
					<label for="inVetrina">In Vetrina:</label> <input type="checkbox"
						id="inVetrina" name="inVetrina" value="true">
				</div>
				<div class="form-group">
					<label for="inCatalogo">In Catalogo:</label> <input type="checkbox"
						id="inCatalogo" name="inCatalogo" value="true">
				</div>
				<div class="form-group">
					<label for="quantità">Quantità:</label> <input type="number"
						id="quantità" name="quantita"
						oninput="validateProductID(this, 'Quantità')" required>
					<div id="prodQuantitàError" class="erromsg" style="display: none;"></div>
				</div>
				<div class="form-group">
					<label for="file">Immagine:</label> <input type="file" id="file"
	...
	<script
		src="${pageContext.request.contextPath}/scripts/shifting_menu_manag_functions_sidebar.js"></script>
	<script
		src="${pageContext.request.contextPath}/scripts/validateNewProduct.js"></script>
	<script
		src="${pageContext.request.contextPath}/scripts/ajax_catalog_table_functions.js?ts=<%=System.currentTimeMillis()%>"></script>
