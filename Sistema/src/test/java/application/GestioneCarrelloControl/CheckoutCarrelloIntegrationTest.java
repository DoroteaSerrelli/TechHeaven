...
public class CheckoutCarrelloIntegrationTest {
	...
	public void testDoPost_TC11_1_1_1() throws ProdottoPresenteException, ProdottoNulloException, IOException, ServletException {
		...
		checkoutController = new CheckoutCarrello(userDAO, gos, ps);
	...
	public void testDoPost_TC11_1_1_2() throws ProdottoPresenteException, ProdottoNulloException, SQLException, IOException, IndirizzoSpedizioneNulloException, ErroreTipoSpedizioneException, ErroreTipoConsegnaException, OrdineVuotoException, ServletException {
		...
		assertThrows(ErroreTipoSpedizioneException.class, () -> {
			gos.creaOrdine(cart, user, idIndirizzo, modSpedizione, modConsegna);
	...
	public void testDoPost_TC11_1_1_4_DatiOrdineCorretti() throws ProdottoPresenteException, ProdottoNulloException, SQLException, IOException, IndirizzoSpedizioneNulloException, ErroreTipoSpedizioneException, ErroreTipoConsegnaException, OrdineVuotoException, ServletException {
		...
		Ordine realOrder = gos.creaOrdine(cart, user, idIndirizzo, modSpedizione, modConsegna);
		
		checkoutController.doPost(request, response);
		
		assertEquals(order, realOrder);
	...
	@Test
	public void testDoPost_TC11_2_1_1() throws ProdottoPresenteException, ProdottoNulloException, IOException, ServletException {
	...
	@Test
	public void testDoPost_TC11_2_1_2() throws ProdottoPresenteException, ProdottoNulloException, SQLException, IOException, IndirizzoSpedizioneNulloException, ErroreTipoSpedizioneException, ErroreTipoConsegnaException, OrdineVuotoException, ServletException {
	...
	@Test
	public void testDoPost_TC11_2_1_3() throws ProdottoPresenteException, ProdottoNulloException, SQLException, IOException, IndirizzoSpedizioneNulloException, ErroreTipoSpedizioneException, ErroreTipoConsegnaException, OrdineVuotoException, ServletException {
	 ...
	 * */
	@Test
	public void testDoPost_TC11_3_1_1() throws ProdottoPresenteException, ProdottoNulloException, IOException, ServletException {
	...
	@Test
	public void testDoPost_TC11_3_1_2() throws ProdottoPresenteException, ProdottoNulloException, SQLException, IOException, IndirizzoSpedizioneNulloException, ErroreTipoSpedizioneException, ErroreTipoConsegnaException, OrdineVuotoException, ServletException {
	...
	@Test
	public void testDoPost_TC11_3_1_3() throws ProdottoPresenteException, ProdottoNulloException, SQLException, IOException, IndirizzoSpedizioneNulloException, ErroreTipoSpedizioneException, ErroreTipoConsegnaException, OrdineVuotoException, ServletException {
