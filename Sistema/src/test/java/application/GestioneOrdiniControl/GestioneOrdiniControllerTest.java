...
import application.GestioneCarrello.GestioneCarrelloService.*;
import application.GestioneOrdini.GestioneOrdiniControl.GestioneOrdiniController;
import application.GestioneOrdini.GestioneOrdiniService.*;
...
public class GestioneOrdiniControllerTest {
	...
	public void testDoPost_AccettazioneOrdineDaSpedireErroreQuantità() throws IOException, OrdineVuotoException, ErroreTipoSpedizioneException, SQLException, CategoriaProdottoException, SottocategoriaProdottoException, ServletException {
		...
		ProxyOrdine orderProxy = new ProxyOrdine(codiceOrdine, Stato.Richiesta_effettuata, indirizzoSpedizione, TipoSpedizione.Spedizione_prime, TipoConsegna.Priority, orderDAO);
