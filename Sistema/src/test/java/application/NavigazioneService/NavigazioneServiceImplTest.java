...
public class NavigazioneServiceImplTest {
	...
	public void TC7_1_1() throws CategoriaProdottoException, SottocategoriaProdottoException, SQLException, ErroreRicercaCategoriaException {
		...
		ProxyProdotto p1 = new ProxyProdotto(1, "Tablet", "Prova", "Prova", Float.valueOf("129.99"), Categoria.TELEFONIA, "Lenovo", "TabM11", 20, true, true, productDAO);
		ProxyProdotto p2 = new ProxyProdotto(2, "Lavatrice", "Prova", "Prova", Float.valueOf("439.99"), Categoria.GRANDI_ELETTRODOMESTICI, "Candy", "White-X", 5, true, false, productDAO);
	...
	public void TC7_1_2() throws CategoriaProdottoException, SottocategoriaProdottoException, SQLException, ErroreRicercaCategoriaException {
		...
		Collection<ProxyProdotto> smallCatalogue = new ArrayList<>();
		ProxyProdotto p1 = new ProxyProdotto(1, "Tablet", "Prova", "Prova", Float.valueOf("129.99"), Categoria.TELEFONIA, "Lenovo", "TabM11", 20, true, true, productDAO);
		ProxyProdotto p2 = new ProxyProdotto(2, "Smartphone", "Prova", "Prova", Float.valueOf("439.99"), Categoria.TELEFONIA, "Samsung", "S9Plus", 5, true, false, productDAO);
