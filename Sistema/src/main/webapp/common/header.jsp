...
<section id="header">
	...
	<div>
		<ul id="navbar">
			...
			<li><a id="lg-bag"> <svg xmlns="http://www.w3.org/2000/svg"
			...
			<li>
				<form id="searchForm" method="post"
					...
					<button class="search" type="submit">
						<img src="<%= request.getContextPath()%>/images/site_images/search.png"
	...
	<div id="carrello">
		<div id="carrelloroba">
			<a href="${pageContext.request.contextPath}/cart">Mostra il
				Carrello</a> <br>
			<%
			...
			<div class="cart-item">
				...
				<span class="product-name"><%= p.getNomeProdotto() %></span> <span><%= p.getTopDescrizione()%></span>
				<span class="quantity">Quantity: <%= p.getQuantita() %></span> <a
					href="#"
				...
				<p id="range_value_<%= p.getCodiceProdotto() %>"
					style="color: goldenrod"><%= p.getQuantita() %></p>
				...
				<a href="#"
					onclick="modifyCart(<%= p.getCodiceProdotto() %>, 'updateQuantità')">Update
					Quantity</a>
				<% } %>
			</div>
			<% }}%>
